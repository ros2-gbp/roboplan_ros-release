...
%global pkg_name roboplan_ros_visualization
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-roboplan-ros-visualization
Version:        0.7.0
Release:        1%{?dist}
...
%description
ROS 2 visualization tools for the RoboPlan library.
...
%changelog
* Sun Sep 20 2026 Sebastian Castro <sebas.a.castro@gmail.com> - 0.7.0-1
